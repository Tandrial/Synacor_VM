...
class CalibrateTeleporter {
  ...
  private static int validate(int r0_target, int r1_target, int r7) {
    int[][] table = new int[r0_target + 1][0x8000];

    for (int r0 = 0; r0 < table.length; r0++)
      for (int r1 = 0; r1 < table[r0].length; r1++)
        if (r0 == 0) // P(0, r1)
          table[0][r1] = (r1 + 1) % 0x8000;
        else if (r1 == 0) // P(r0, 0)
          table[r0][0] = table[r0 - 1][r7];
        else // P(r0, r1)
          table[r0][r1] = table[r0 - 1][table[r0][r1 - 1]];
    return table[r0_target][r1_target];
  }
